/**
 * Source file is in "release" area. The build process copies it into the normal source tree.
 */
package redistrict.colorado.system;

public class Version {
	public final static String BUILD_DATE="Sept 10,2020";
	...
	public final static String NAME = "DistrictPlanAnalyzer";
