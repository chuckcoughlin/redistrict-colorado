...
public class NTv2GridShiftTransformation extends AbstractCoordinateOperation implements GridBasedTransformation {
	private static final String CLSS = "NTv2GridShiftTransformation";
    ...
    public NTv2GridShiftTransformation(URL ntv2_gridFile) {
        ...
        if (ntv2_gridFile == null) {
            LOGGER.warning("No NTv2 Grid file specified.");
        }
        this.gsf = new GridShiftFile();
        this.precision = 0.1;
    }
    ...
    public CoordinateOperation inverse() {
        ...
        try {
            ...
            LOGGER.severe("Could not load GridShiftFile " + grid_file);
        }
            ...
            if (mode == 0) {
                if (grid_file.getProtocol().equals("file")) {
                    ...
                    try {
                        ...
                        if (is == null) {
                            LOGGER.warning("This grid doesn't exist or cannot be read.");
                        }
                        else {
                        ...
                        e.printStackTrace();
                        LOGGER.severe(String.format("%s.loadGridShiftFile: This grid doesn't exist or cannot be read (%s).",CLSS, e.getLocalizedMessage()));
                    }
                } else {
                ...
                if (grid_file.getProtocol().equals("file")) {
                    ...
                    LOGGER.warning("This grid cannot be accessed.");
                }
            } else {
                LOGGER.warning("This mode is not supported. The grid won't be used.");
            }
        } else {
            LOGGER.warning("The location of the grid is null. Any grid will be used.");
        }
    }
