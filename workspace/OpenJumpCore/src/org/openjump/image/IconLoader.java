...
public class IconLoader {
	private static final String CLSS = "IconLoader";
	...
	protected static ImageIcon getIcon(Class clazz, String filename) {
		...
		if (url == null) {
			LOGGER.severe("Couldn't find '"+filename+"' via resource loading. Returning dummy default icon for now.");
	...
	protected static ImageIcon getIcon(URL url) {
		...
		try {
			...
			LOGGER.severe("Error loading '"+key+"'. Using dummy default icon for now. "+e.getLocalizedMessage());
		}
