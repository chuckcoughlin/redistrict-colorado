 ...
 * 
 */
public class GMLWriterWrapper implements JUMPWriter, TaskMonitorSupport {
    ...
    public void setDateFormatter(SimpleDateFormat formatter) { dateFormatter = formatter; }  
