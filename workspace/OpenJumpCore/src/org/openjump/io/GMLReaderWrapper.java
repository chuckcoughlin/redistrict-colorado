...
import org.openjump.geometry.feature.FlexibleFeature;
import org.openjump.task.DummyTaskMonitor;
import org.openjump.task.TaskMonitor;
import org.openjump.task.TaskMonitorSupport;
import org.openjump.task.TaskMonitorUtil;
import org.openjump.util.Timer;
 ...
 *
 */
public class GMLReaderWrapper extends DefaultHandler implements JUMPReader, TaskMonitorSupport {
...
//  private int currentGeometryNumb = 1;
  ...
  private SAXParser xr; // see above
