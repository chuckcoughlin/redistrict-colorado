...
import org.openjump.geometry.feature.FlexibleFeatureSchema;
    ...
    public void load(Object o, String readerName)
        ...
        try {
          if (o instanceof Reader)
            xr.parse(new InputSource((Reader)o),this);
          else if (o instanceof InputStream)
            xr.parse(new InputSource((InputStream)o),this);
          else
    ...
    public void endElement(String uri, String name, String qName)
        ...
        try {
            ...
            if (qName.equalsIgnoreCase("type")) {
                ...
                try {
                    columnDef_type = AttributeType.toAttributeType(t);
