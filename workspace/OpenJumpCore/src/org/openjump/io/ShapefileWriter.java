...
public class ShapefileWriter implements JUMPWriter {
    ...
    private String getPrjString(String fname, String registry, String code)
        ...
        if (Class.forName("org.cts.CRSFactory") != null) {
            ...
            if (registry.equals("EPSG")) registryManager.addRegistry(new EPSGRegistry());
            if (registry.equals("ESRI")) registryManager.addRegistry(new ESRIRegistry());
            CoordinateReferenceSystem crs = crsFactory.getCRS(registry + ":" + code);
