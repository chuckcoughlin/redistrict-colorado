...
package org.openjump.util.commandline;
...
public class OptionSpec {
  ...
  private void checkNumArgs(String[] args) throws ParseException {
    ...
    // more can as well be files that were carelessly placed
      ...
      StringBuffer sb = new StringBuffer(names.elementAt(nNeededArgs));
      for(int i=nNeededArgs+1;i<args.length;i++) {
    	  sb.append(",");
    	  sb.append(names.elementAt(i));
      }
      String msg = I18N.getMessage(FileUtil.I18NPREFIX
