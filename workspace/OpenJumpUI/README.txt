...
and the following plugins
 ...
 Concave Hull (Eric Grosso) - LGPL2.1, GPL2 - lgpl-2.1.txt, gpl-2.txt
  ConcaveHull*.{jar,txt}
 CTS extension (Micha�l Michaud) - GPL2 - gpl-2.txt
  CTS-PlugIn-*.jar,
 ...
 KML Driver (skyjump) - GPL2 - gpl-2.txt
  kml-driver-*.jar
 Matching (Micha�l Michaud) - GPL2 - gpl-2.txt
   matching-*.jar
   utils-*.jar
 ...
 SetAttributes (Micha�l Michaud) - GPL2 - gpl-2.txt
  SetAttributes-.jar
  jaxb/jaxb-*.jar
 ...
 Vertex Symbols (com.cadplan.jump) - GPL2 - gpl-2.txt
  VertexSymbols.jar
  itext-*.jar - LGPL2.1 - lgpl-2.1.txt
 View Manager Extension (Micha�l Michaud) - GPL2 - gpl-2.txt
  ViewManager-*.jar
  jaxb/jaxb-*.jar
 WFS Plugin
