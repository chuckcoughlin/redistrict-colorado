...
import org.openjump.util.CollectionMap;
import org.openjump.util.StringUtil;
import org.openjump.workbench.layer.RasterImageLayer;
...
public abstract class AbstractMultiInputDialog extends JDialog {
	private static final String CLSS = "AbstractMultiInputDialog";
    ...
    public Object getValue(String fieldName) {
        ...
        if (component == null) {
            LOGGER.severe("No component labelled '" + fieldName
                    + "' in this dialog.");
            return null;
        }
