...
import org.openjump.ui.util.FormUtils;
...
public class ConfigTooltipPanel extends OptionsPanelV2 {
    ...
    @Override
    public void init() {
        boolean layerTooltipsOn = PersistentBlackboardAction.get(blackboard)
    ...
    public void okPressed() {
    	PersistentBlackboardAction.get(blackboard).put(LAYER_TOOLTIPS_ON,
