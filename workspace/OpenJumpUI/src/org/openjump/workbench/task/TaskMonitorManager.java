...
package org.openjump.workbench.task;
...
import org.openjump.ui.action.ThreadedAction;
import org.openjump.util.StringUtil;
import org.openjump.workbench.WorkbenchUtilities;
import org.openjump.workbench.component.TaskMonitorDialog;
...
public class TaskMonitorManager {
     ...
     */
    public void execute(ThreadedAction plugIn, ActionContext context) {
        ...
        WorkbenchUtilities.centreOnWindow(progressDialog);
    ...
    private Timer timer(final Date start, final ThreadedAction plugIn,
    ...
    private class TaskWrapper extends Thread {
        private ThreadedAction plugIn;

        private ActionContext context;

        private TaskMonitorDialog dialog;

        public TaskWrapper(ThreadedAction plugIn, ActionContext context,
