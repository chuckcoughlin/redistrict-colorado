...
import org.openjump.geometry.feature.FeatureCollectionWrapper;
import org.openjump.geometry.feature.FeatureDataset;
import org.openjump.geometry.feature.FeatureSchema;
import org.openjump.geometry.feature.Operation;
import org.openjump.ui.action.AddNewLayerAction;
import org.openjump.util.Blackboard;
import org.openjump.workbench.renderer.style.BasicStyle;
import org.openjump.workbench.renderer.style.SRIDStyle;
import org.openjump.workbench.renderer.style.Style;
import org.openjump.workbench.renderer.style.VertexStyle;
import org.openjump.workbench.ui.Disposable;
...
public class Layer extends AbstractLayerable implements LayerManagerProxy, Disposable {
  ...
  public void setFeatureCollection(final FeatureCollection featureCollection) {
    final FeatureCollection oldFeatureCollection = featureCollectionWrapper != null ? featureCollectionWrapper
        .getUltimateWrappee() : AddNewLayerAction
  ...
  public void dispose() {
    ...
    setFeatureCollection(AddNewLayerAction.createBlankFeatureCollection());
  }
