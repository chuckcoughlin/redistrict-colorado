...
public class BasicStyle implements Style, StrokeStyle, FillStyle, AlphaSetting {
    ...
    public void setLineColor(Color lineColor) {
        this.lineColor = WorkbenchUtilities.alphaColor(lineColor, getAlpha());
    }
    ...
    public Color getFillColor() {
        return WorkbenchUtilities.alphaColor(fillColor, 255);
    }

    public Color getLineColor() {
        return WorkbenchUtilities.alphaColor(lineColor, 255);
    }
    ...
    public void setAlpha(int alpha) {
        ...
        lineColor = WorkbenchUtilities.alphaColor(lineColor, alpha);
    }
