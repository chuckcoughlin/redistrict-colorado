...
import org.openjump.common.JUMPVersion;
import org.openjump.common.util.commandline.Option;
import org.openjump.common.util.commandline.ParseException;
import org.openjump.common.workbench.ui.SplashWindow;
import org.openjump.common.workbench.ui.images.IconLoader;
import org.openjump.common.workbench.ui.network.ProxySettingsOptionsPanel;
import org.openjump.common.workbench.ui.plugin.PersistentBlackboardPlugIn;
import org.openjump.common.workbench.ui.plugin.skin.InstallSkinsPlugIn;
import org.openjump.task.TaskMonitor;
import org.openjump.util.Blackboard;
import org.openjump.util.LangUtil;
import org.openjump.util.commandline.CommandLine;
import org.openjump.util.commandline.OptionSpec;
import org.openjump.workbench.component.ErrorDialog;
...
public class JUMPWorkbench {
  ...
  private ActionManager plugInManager;
  ...
  public JUMPWorkbench(String title, String[] args, final Component s,
    ...
    if (commandLine.hasOption(STATE_OPTION)) {
      ...
      if (option.isDirectory()) {
        PersistentBlackboardAction.setPersistenceDirectory(option.getPath());
      }
      if (option.isFile()) {
        PersistentBlackboardAction.setFileName(option.getName());
        PersistentBlackboardAction.setPersistenceDirectory(option
            .getAbsoluteFile().getParent());
      }
    }

    plugInManager = new ActionManager(context, extensionsDirectory, monitor);
...
//          new Insets(0, 0, 0, 10), 0, 0));
  ...
  static void main(String[] args, String title, JComponent splashComponent,
    ...
    PersistentBlackboardAction persistentBlackboard = new PersistentBlackboardAction();
    ...
    ProxySettingsOptionsPanel.restoreSystemSettings(PersistentBlackboardAction
  ...
  public ActionManager getPlugInManager() {
