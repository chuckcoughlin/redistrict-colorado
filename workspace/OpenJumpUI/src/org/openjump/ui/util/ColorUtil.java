...
import org.openjump.workbench.renderer.style.ColorScheme;
...
public class ColorUtil {
    ...
    public static ColorScheme createRandomColorSchema(int intervals)
        ...
        for (int c = 1; c < intervals; c++) {
            ...
            final Color color = interpolateColor(startColor,
    ...
    static public Color interpolateColor(Color startColor, Color endColor, double relDistance) throws Exception {
    ...
    static private int interpolate(int startValue, int endValue, double relDistance) {
