...
import org.openjump.common.JUMPException;
import org.openjump.common.util.Timer;
import org.openjump.common.workbench.ui.cursortool.CursorTool;
import org.openjump.common.workbench.ui.cursortool.CursorToolPluginWrapper;
import org.openjump.task.TaskMonitor;
import org.openjump.util.StringUtil;
import org.openjump.workbench.WorkbenchContext;
import org.openjump.workbench.WorkbenchProperties;
...
public class ActionManager {
     ...
     */
    public ActionManager(WorkbenchContext context, File plugInDirectory,
...
//            mycl.addUrls(((URLClassLoader) mycl.getParent()).getURLs());
    ...
    private void loadConfigurations() {
      ActionContext pc = context.createPlugInContext();
...
//                        + installSetting + " with orderid = " + orderSetting);
          ...
          AbstractAction.registerShortcuts(plugIn);
