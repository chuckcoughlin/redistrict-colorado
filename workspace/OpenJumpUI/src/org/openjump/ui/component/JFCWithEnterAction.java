package org.openjump.ui.component;
...
import org.openjump.workbench.ui.RecursiveKeyListener;
...
public class JFCWithEnterAction extends JFileChooser {
	private static final String CLSS = "JFCWithEnterAction";
	...
	public File getSelectedFile() {
		...
		try {
			...
			LOGGER.severe(String.format("%s:getSelectedFile: ERROR (%s)",CLSS,e.getLocalizedMessage()));
		}
