...
public class ArrayTester extends Application {
	private static final String CLSS = "ArrayTester";
    ...
    private void runTests() {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            LOGGER.fine("testArrays push " + i + " gives len: " + len);
        }
        
        LOGGER.fine("testArrays toString: " + ary.toString());
        
        ary.reverse();
        
        LOGGER.fine("testArrays reverse toString: " + ary.toString());
        
        ary.reverse();
        
        Object obj = ary.pop();
        
        LOGGER.fine("testArrays popped: " + obj);
        LOGGER.fine("testArrays popped toString: " + ary.toString());
        ...
        LOGGER.fine("testArrays unshift JsO toString: " + ary.toString());
        
        Object jso1 = ary.shift();
        
        LOGGER.fine("testArrays shift JsO: " + jso1);
        LOGGER.fine("testArrays shift JsO reference equality: " + (jso == jso1));
        LOGGER.fine("testArrays shift JsO toString: " + ary.toString());
        
        ary.push(jso);
        LOGGER.fine("testArrays push JsO toString: " + ary.toString());
        ...
        LOGGER.fine("testArrays alter JsO toString: " + ary.toString());
        
        Object jso2 = ary.get(ary.length() - 1);
        LOGGER.fine("testArrays get JsO2: " + jso2);
