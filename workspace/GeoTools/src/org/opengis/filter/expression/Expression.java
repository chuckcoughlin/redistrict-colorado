 ...
 *
 * <p>The most common use is with potentially using {@linkplain Feature feature} and metadata. The
...
public interface Expression {
     ...
     *
     * <p>This constant is a "NullObject" that can represent the absense of expression in a data
     * structures. As example it can be used to represent the default stroke color in a
     * LineSymbolizer Stroke structure.
     */
