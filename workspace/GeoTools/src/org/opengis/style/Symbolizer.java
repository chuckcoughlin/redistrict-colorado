...
public interface Symbolizer {
     ...
     *
     * <p>The content of the element gives the property name in XPath syntax. In principle, a fixed
    ...
    /**
     * Exrepssion used to define a geometry for drawing. May return null if the default geometry
     * attribute should be used. This expression is often a PropertyName.
     *
     * @return Expression used to define a geometry for drawing, or Expression.NIL if the default
