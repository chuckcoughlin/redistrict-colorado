...
public class IdentityTransform extends AbstractMathTransform
    ...
    private static final int DIM2 = 2; // Must be the dimension which handling Coordinates

    /** The input and output dimension. */
    private final int dimension;

    /**
     * Cache of identity transforms for dimensions ranging from to 0 to 7. 
    ...
    /** Constructs a 2 dimensional identity transform  */
    public static synchronized LinearTransform create(final int dimension) {
        ...
        switch (dimension) {
            case 1:
                candidate = IdentityTransform1D.IDENTITY;
                break;
            case 2:
