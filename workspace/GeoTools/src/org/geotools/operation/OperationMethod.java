...
public class OperationMethod extends IdentifiedObject  {
    ...
    private static final String CLSS = "OperationMethod";
    ...
    private OperationMethod(
        ...
        formula = (String) subProperties.get(FORMULA_KEY);
    ...
    private static void ensurePositive(final String name, final int value)
        ...
        if (value < 0) {
            throw new IllegalArgumentException(String.format("%s.ensurePositive: Illegal argument %s = %d",CLSS,name,value));
        }
    }
    ...
    public static void checkDimensions(final OperationMethod method, MathTransform transform)
        ...
        if (method != null && transform != null) {
            ...
            throw new IllegalArgumentException(String.format("%s.checkDimensions: %s Mismatched dimension %d vs %d", CLSS,name,actual,expected));
        }
    }
}
