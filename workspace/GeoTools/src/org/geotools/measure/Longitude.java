...
/**
 * A longitude angle in degrees. Positive longitudes are East, while negative longitudes are West.
 *
 * @since 2.0
 * @version $Id$
...
public final class Longitude extends Angle {
     ...
     */
    public Longitude(final String angle) throws NumberFormatException {
