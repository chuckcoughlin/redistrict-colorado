...
/**
 * A latitude angle in degrees. Positive latitudes are North, while negative latitudes are South. This class
...
public final class Latitude extends Angle {
     ...
     *
     * @param angle A string to be converted to a {@code Latitude}.
     * @throws NumberFormatException if the string does not contain a parsable latitude.
     */
    public Latitude(final String angle) throws NumberFormatException {
        super(Double.parseDouble(angle));
    }
}
