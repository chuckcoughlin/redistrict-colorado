...
/**
 * Utility methods for affine transform. This class provides a set of public static methods working 
 * on any {@link AffineTransform}.
 *
 * @since 2.3
 * @version $Id$
...
public class XAffineTransform extends AffineTransform {
	private final static String CLSS = "TransformedShape";
