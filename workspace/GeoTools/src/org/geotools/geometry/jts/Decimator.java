...
public final class Decimator {
     ...
     * @param pixelDistance
     */
    public Decimator(AffineTransform screenToWorld, Rectangle paintArea, double pixelDistance) {
     ...
     * @param paintArea
     */
    public Decimator(AffineTransform screenToWorld, Rectangle paintArea) {
    ...
    public static double[] computeGeneralizationDistances(
    		AffineTransform screenToWorld, Rectangle paintArea, double pixelDistance) {
     ...
     * @throws TransformException
     */
    static double[] getGeneralizationSpans(double x, double y, AffineTransform transform) {
    ...
    public final Geometry decimateTransformGeneralize(Geometry geometry, AffineTransform transform) {
        if (geometry instanceof GeometryCollection) {
            ...
            */
            ...
            LiteCoordinateSequence seq = new LiteCoordinateSequence(ls.getCoordinates());
