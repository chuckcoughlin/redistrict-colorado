...
public final class Decimator {
    ...
    public final Geometry decimate(Geometry geom) {
        ...
        if (geom instanceof GeometryCollection) {
            ...
            DecimatedGeometryCollection collection = new DecimatedGeometryCollection(new Geometry[count],current.getFactory());
            ...
            DecimatedPolygon poly = new DecimatedPolygon((LinearRing)(line.getExteriorRing()),holes,line.getFactory());
