 ...
 *     2.0).
 */
public class DirectPosition implements Cloneable, Serializable {
     ...
     * @param crs
     */
    public DirectPosition(final CoordinateReferenceSystem crs) {
        setCRS(crs);
     ...
     * @param ordinates
     */
    public DirectPosition(final CoordinateReferenceSystem crs, final double[] ordinates) {
        setCRS(crs);
        this.ordinates = new double[crs.getCoordinateSystem().getDimension()];
    ...
    public int hashCode() {
        ...
        result = PRIME * result + DirectPosition.hashCode(ordinates);
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final DirectPosition other = (DirectPosition) obj;
        if (crs == null) {
