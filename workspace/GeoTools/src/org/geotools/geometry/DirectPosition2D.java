 ...
 * implements the later. Consequently, <strong>{@link #hashCode} is inconsistent with {@link
...
public class DirectPosition2D extends Point2D.Double implements DirectPosition, Serializable, Cloneable {
     ...
     */
    public DirectPosition2D(final CoordinateSystem crs) {
     ...
     * @param y The <var>y</var> value.
     */
    public DirectPosition2D(final CoordinateSystem crs, final double x, final double y) {
        super(x, y);
        setCoordinateSystem(crs);
    }
    ...
    public DirectPosition2D(final Point2D point) {
        ...
        if (point instanceof DirectPosition) {
            setCoordinateSystem(((DirectPosition) point).getCoordinateSystem());
        }
    }
     ...
     */
    public final CoordinateSystem getCoordinateSystem() {return crs;}
     ...
     * {@linkplain CoordinateSystem coordinate reference system}, then the CRS for this
    ...
    public void setLocation(final DirectPosition position) throws MismatchedDimensionException {
        setCoordinateSystem(position.getCoordinateSystem());
     ...
     * instance of {@link org.geotools.measure.CoordinateFormat}. (from AbstractDirectPosition)
     */
    @Override
     ...
     *
     * @return A hash code value for this position (from AbstractDirectPosition).
     */
    @Override
    public int hashCode() {
    	final int dimension = crs.getDimension();
            int code = 1;
            for (int i = 0; i < dimension; i++) {
                final long bits = java.lang.Double.doubleToLongBits(getOrdinate(i));
    ...
    public boolean equals(final Object object) {
        ...
        if (object instanceof DirectPosition) {
            ...
            if (other.getDimension() == 2
                    ...
                    && Utilities.equals(other.getCoordinateSystem(), crs)) {
