...
public class FeatureEvent extends EventObject {
    ...
    protected FeatureCollection featureSource;
    ...
    public FeatureEvent(Object source, Type type, ReferencedEnvelope bounds, Filter filter) {
        ...
        if (source instanceof FeatureCollection) {
            this.featureSource = (FeatureCollection) source;
        }
    }
    ...
    public FeatureCollection getFeatureSource() {
        return FeatureCollection;
    }

    @SuppressWarnings("rawtypes")
    public void setFeatureSource(FeatureCollection featureSource) {
