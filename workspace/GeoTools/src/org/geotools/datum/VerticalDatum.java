...
public class VerticalDatum extends Datum  {
    ...
    public static final VerticalDatum GEOIDAL =
            new VerticalDatum(name(VocabularyKeys.GEOIDAL), VerticalDatumType.GEOIDAL);
     ...
     * @since 2.2
     */
    public VerticalDatum(final VerticalDatum datum) {
        super(datum);
     ...
     * @param type The type of this vertical datum.
     */
    public VerticalDatum(final Map<String, ?> properties, final VerticalDatumType type) {
        super(properties);
        this.type = type;
