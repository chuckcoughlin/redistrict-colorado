...
public class BasicDatum implements Datum {
     ...
     */
    public BasicDatum(final Map<String,Object> props) {
        this.properties = props;
    }
    
    public String getName() { return (String)properties.get(IdentifiedObject.NAME_KEY); }
    ...
    public String getAnchorPoint() {
        return (String)properties.get(Datum.ANCHOR_POINT_KEY);
    }
    ...
    public String getScope() {
    	return (String)properties.get(Datum.SCOPE_KEY);
    }
}
