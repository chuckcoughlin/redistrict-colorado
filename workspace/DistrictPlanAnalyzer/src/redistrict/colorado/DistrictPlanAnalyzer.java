...
public class DistrictPlanAnalyzer extends Application {
	private final static String CLSS = "DistrictPlanAnalyzer";
	private static Logger LOGGER = Logger.getLogger(CLSS);
	private static final String LOG_ROOT = CLSS.toLowerCase();
	public final static String TITLE  = "District Plan Analyzer";
